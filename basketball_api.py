...
ALLOWED_LEAGUES = {
    ...
    # Ulusal - Avrupa
    "bbl":               True,  # Almanya
    "pro a":             True,  # Almanya 2. lig
    "lnb pro a":         True,  # Fransa
    "pro b":             True,  # Fransa 2. lig
    "lega basket":       True,  # İtalya
    "lba":               True,  # İtalya
    "liga acb":          True,  # İspanya
    "acb":               True,  # İspanya
    "liga endesa":       True,  # İspanya
    "bsn":               True,  # Portekiz
    "bnxt":              True,  # Belçika/Hollanda
    "vbt":               True,  # Belçika
    "beko bbl":          True,  # Almanya
    "ebl":               True,  # Danimarka
    "nbl":               True,  # Norveç/Avustralya
    "basketliiga":       True,  # Finlandiya
    "kkl":               True,  # Çek Cumhuriyeti
    "nba":               True,  # ABD
    "g league":          True,  # ABD 2. lig
    "bsl":               True,  # Türkiye
    "bsktbl sl":         True,  # Türkiye
    "türkiye basket":    True,  # Türkiye
    "bsuperlig":         True,  # Türkiye
    "basket sl":         True,  # Türkiye
    "tb2l":              True,  # Türkiye 2. lig
    "vef":               True,  # Letonya/Baltic
    "lkl":               True,  # Litvanya
    "bbl":               True,  # Beyaz Rusya
    "vtb united":        True,  # VTB United
    "vtb":               True,
    "pbl":               True,  # Rusya
    "ncaa":              True,  # ABD kolej
    "superleague":       True,  # Yunanistan
    "basket league":     True,  # Yunanistan
    "lbbl":              True,  # Lüksemburg
}
